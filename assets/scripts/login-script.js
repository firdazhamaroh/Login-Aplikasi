/**@module login-Script*/
/**
 *Membuat variabel loinFormElement untuk tampilan form.
...
/**
*Membuat variabel expectedEmail untuk meyimpan informasi email sementara.
*@constant {string}
*/
...
loginFormElement.addEventListener('submit', function(event) {
  ...
  */
  ...
  if (email == expectedEmail && password == expectedPassword) {
    ...
    */ Cpmment : jika sesuai maka program akan berpindah ke halaman home.*/
    goToHome();
